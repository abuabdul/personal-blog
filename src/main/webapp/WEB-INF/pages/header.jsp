			...
			<div class="nav-collapse collapse">
				<p class="navbar-text pull-right margin-top">
					...
					<span class="tooltip-place"> <a href="#"
						...
						title="as of 09/21/2013" class="label"> <i
				...
				<ul class="nav">
					...
					<li class="tooltip-place"><a href="https://blogs.abuabdul.com"
						data-toggle="tooltip" data-placement="bottom" title="My Blog">
					...
					<li class="tooltip-place"><a
						...
						data-placement="bottom" title="Trello"> <span
							class="icon-stack"> <i
								class="icon-check-empty icon-stack-base"></i> <i
								class="icon-trello"></i>
						</span>
					...
					<li class="tooltip-place"><a
						...
						data-toggle="tooltip" data-placement="bottom"
						title="StackOverFlow"> <span class="icon-stack"> <i
								class="icon-check-empty icon-stack-base"></i> <i
					...
					<li class="tooltip-place"><a
						...
						data-placement="bottom" title="GitHub"> <span
							class="icon-stack"> <i
								class="icon-check-empty icon-stack-base"></i> <i
								class="icon-github"></i>
						</span>
